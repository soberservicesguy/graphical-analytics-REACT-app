...
class HeadingOverBoldHeadingOverFourCard extends Component {
	constructor(props) {
		super(props);
// STATE	
		this.state = {
	...
	render() {
		...
		return (
			<Grid container direction="column" alignItems="center" justify="center" style={{
				...
				margin:'auto', 
				marginBottom: 50, 
				boxShadow: '0 4px 12px 0 rgba(0, 0, 0, 0.1), 0 6px 25px 0 rgba(0, 0, 0, 0.09)',
			}} >
				<Grid item xs={12}>
					<div>
...
HeadingOverBoldHeadingOverFourCard.defaultProps = {
	//:,
	smallerHeading:'KEY HEIGHLIGHTS',
	largerHeading:'6 million users. 45 brands. 185 countries',
};

export default withRouter(withResponsiveness(withStyles(styles)(HeadingOverBoldHeadingOverFourCard)));
